 ...
 * @author Daniel
 */
public class ASB extends JInternalFrame implements ActionListener {
    ...
    public void ocultarBarraTitulo() {
        this.barra = ((javax.swing.plaf.basic.BasicInternalFrameUI) getUI()).getNorthPane();
        this.dimensionBarra = this.barra.getPreferredSize();
        this.barra.setSize(0, 0);
        this.barra.setPreferredSize(new Dimension(0, 0));
        repaint();
    }
    ...
    public void llenaContenido() {
        ...
        for (int i = 0; i < this.encuestaActual.getPreguntas().size(); i++) {
            ...
            this.posicionEnGrid++;
            this.jpDinamico.add(enunciado, this.gridBagDinamico);
